...
namespace ChatJuego.Cliente
{
    ...
    public partial class EnviarInvitacion : Window
    {
            ...
            if (!string.IsNullOrWhiteSpace(TBUsuarioInvitacion.Text))
            {
                if (jugador.usuario != TBUsuarioInvitacion.Text)
                {
                    try
                    {
                        ...
                        {
                            NotificarErrorUsuarioNoEncontrado();
                        }
                        else if (estado == EstadoDeEnvio.Fallido)
                        {
                            NotificarErrorEnvioFallido();
                        }
                        else
                        {
                            NotificarInvitacionEnviada();
                            VentanaDeJuego ventanaDeJuego = new VentanaDeJuego(menuPrincipal, jugador, servidorDelChat, codigoDePartida, jugadorCallBack, servidor);
                            ventanaDeJuego.Show();
                ...
                {
                    NotificarErrorInvitacionMismoJugador();
                }
            } else
            {
                NotificarIngresarInformacion();
            }
        }
        ...
        /// </summary>
        private static void NotificarErrorDeConexión()
        {
        ...
        /// <summary>
        /// Muestra el mensaje de invitación enviada
        /// </summary>
        private void NotificarInvitacionEnviada()
        {
        ...
        /// <summary>
        /// Muestra el mensaje de error de información faltante
        /// </summary>
        private void NotificarIngresarInformacion()
        {
        ...
        /// <summary>
        /// Muestra el mensaje de error de invitarse a uno mismo
        /// </summary>
        private void NotificarErrorInvitacionMismoJugador()
        {
            MenuPrincipal.ReproducirError();
            if (idioma == Idioma.Espaniol)
            {
        ...
        /// <summary>
        /// Muestra el mensaje de error de envío fallido
        /// </summary>
        private void NotificarErrorEnvioFallido()
        {
            MenuPrincipal.ReproducirError();
            if (idioma == Idioma.Espaniol)
            {
        ...
        /// <summary>
        /// Muestra el mensaje de error usuario no encontrado
        /// </summary>
        private void NotificarErrorUsuarioNoEncontrado()
        {
            MenuPrincipal.ReproducirError();
            if (idioma == Idioma.Espaniol)
            {
        ...
        private void ActualizarIdioma()
        {
            if (idioma == Idioma.Espaniol)
            {
                ...
                BotonEnviarInvitacion.Source = new BitmapImage(new Uri("Iconos/botonEnviarInvitacion.png", UriKind.Relative));
            }
            else if (idioma == Idioma.Frances)
            {
                ...
                BotonEnviarInvitacion.Source = new BitmapImage(new Uri("Iconos/botonEnviarInvitacionFR.png", UriKind.Relative));
            }
            else if (idioma == Idioma.Portugues)
            {
                ...
                BotonEnviarInvitacion.Source = new BitmapImage(new Uri("Iconos/botonEnviarInvitacionPO.png", UriKind.Relative));
            }
            else if (idioma == Idioma.Ingles)
            {
                ...
                BotonEnviarInvitacion.Source = new BitmapImage(new Uri("Iconos/botonEnviarInvitacionIN.png", UriKind.Relative));
            }
        }
