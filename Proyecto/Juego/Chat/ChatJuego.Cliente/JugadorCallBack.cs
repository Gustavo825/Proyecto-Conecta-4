...
namespace ChatJuego.Cliente
{
    public class JugadorCallBack : Proxy.IChatServicioCallback
    {
        ...
        {
            chat.PlantillaMensaje.Items.Add(new { FondoElemento = "White", FondoCabecera = "Salmon", Nombre = jugador.usuario, TiempoDeEnvio = mensaje.TiempoDeEnvio.ToString(), MensajeEnviado = mensaje.ContenidoMensaje });
            chat.UsuariosConectados.Items.Clear();
